...
const Section1=()=>{
  ...
  <div class="container">
    ...
    <div class="content_container">
      <h6><b>OUR CEO AND FOUNDER</b></h6>
      <h1><b>JAMAL <span className='text_grad_red'>MAHIJIBAI</span><br/>PRESIDENT & CEO</b></h1><br />
  ...
  <h6><b>TOP TIER STAFFING</b></h6>
  <h1><b>OUR TOP-TIER <span className='text_grad_red'>STAFFING SOLUTIONS</span><br />
  ARE DESIGNED WITH YOU IN MIND.
   </b> </h1><br />
   <div className='p-txt'>
   <p>By providing top-tier staffing solutions, we empower healthcare institutions and professionals, becoming  a trusted partner to facilities nationwide. <span> <b> <i>We ensure that every shift transforms lives, elevates care,and enhances societal well-being.</i></b></span></p>
   </div>
  </div>
